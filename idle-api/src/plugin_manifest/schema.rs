...
fn invalid(key: &str, want: &str) -> String {
...
fn req_u32(t: &Value, key: &str) -> Result<u32, String> {
    match t.get(key) {
        Some(v) => v
            .as_int()
...
fn opt_str(t: &Value, key: &str, dflt: String) -> Result<String, String> {
    match t.get(key) {
        None => Ok(dflt),
        Some(v) => v
            .as_str()
...
fn opt_bool(t: &Value, key: &str, dflt: bool) -> Result<bool, String> {
    match t.get(key) {
        None => Ok(dflt),
...
fn opt_u32(t: &Value, key: &str, dflt: u32) -> Result<u32, String> {
    match t.get(key) {
        None => Ok(dflt),
        Some(v) => v
            .as_int()
...
fn opt_str_list(t: &Value, key: &str) -> Result<Vec<String>, String> {
    match t.get(key) {
        None => Ok(Vec::new()),
        Some(v) => v
            .as_array()
